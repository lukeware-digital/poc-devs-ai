...
class BaseAgent:
    ...
    def __init__(self, agent_id: str, llm_layer: Any, 
                 shared_context: Any, rag_retriever: Any,
                 guardrails: Any):
    ...
    async def execute(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            allowed, reason = await self.guardrails.check_permission(
                self.agent_id, operation, task.get('context', {})
            )
            if not allowed:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        avg_response_time = (self.metrics['total_response_time'] / self.metrics['success_count']) if self.metrics['success_count'] > 0 else 0
