...
class RAGRetriever:
    ...
    def retrieve(self, query: str, doc_type: str = None, n_results: int = 5, 
    ...
    def retrieve_by_semantic_similarity(self, query: str, context_type: str, 
    ...
    def hybrid_retrieval(self, semantic_query: str, keyword_query: str = None, 
                        doc_type: str = None, n_results: int = 5) -> List[Dict[str, Any]]:
        """
    ...
    def get_context_summary(self, query: str, context_type: str = 'technical', 
        ...
        for i, result in enumerate(results, 1):
            ...
            if doc_type == 'code':
                ...
                summary_parts.append(f"REQUISITO RELACIONADO (relevância: {similarity:.2f}):\n{content.strip()[:200]}...")
            else:
    ...
    def get_code_examples(self, functionality: str, language: str = None, 
                         n_examples: int = 2) -> List[Dict[str, Any]]:
        """
