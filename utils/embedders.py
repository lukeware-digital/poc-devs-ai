...
class SentenceTransformerEmbedder(BaseEmbedder):
    ...
    def _initialize_model(self):
        ...
        try:
            ...
            logger.warning("Bibliotecas sentence-transformers ou torch não encontradas. Usando SimpleEmbedder como fallback.")
            self.model = None
...
class HybridEmbedder(BaseEmbedder):
    ...
    def __init__(self, 
                 semantic_embedder: Optional[BaseEmbedder] = None,
                 technical_embedder: Optional[BaseEmbedder] = None,
                 contextual_embedder: Optional[BaseEmbedder] = None):
        """
    ...
    def batch_embed(self, texts: List[str], content_types: Optional[List[str]] = None) -> List[List[float]]:
        """
        ...
        return [self.embed(text, content_type) for text, content_type in zip(texts, content_types)]
...
class CodeSpecificEmbedder(BaseEmbedder):
    ...
    def __init__(self, base_embedder: Optional[BaseEmbedder] = None, 
    ...
    def batch_embed(self, codes: List[str], languages: Optional[List[str]] = None) -> List[List[float]]:
        """
        ...
        return [self.embed(code, lang) for code, lang in zip(codes, languages)]
